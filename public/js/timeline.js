//Sample dates
var dates = ["6/1/2019", "6/15/2018", "8/11/2019", "10/30/2020", "11/15/2021"];
...
function makeCircles() {
  ...
  if (dates.length < 2) {
    ...
    $("#mainCont").append('<span id="span0" class="center">'+ "Founding team, " + dateSpan(dates[0]) + '</span>');
    ...
    for (i = 1; i < dates.length - 1; i++) {
      ...
      $("#mainCont").append('<span id="span' + i + '" class="right">' + "Executive Team, " + dateSpan(dates[i]) + '</span>');
    }
